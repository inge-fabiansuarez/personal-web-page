...
<head>
    ...
    <title>Fabian Enrique Suarez Carvajal</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <meta name="description" content="Fabian Enrique Suarez Carvajal">
    ...
    <style>
        .portfolio-filters i {
            font-size: 20px;
            /* Ajusta el tamaño aquí para los íconos */
            margin-right: 5px;
        ...
        .portfolio-filters a {
            font-size: 20px;
            /* Ajusta el tamaño aquí para el texto */
            color: #000;
        ...
        .portfolio-filters a:hover {
            color: #007bff;
            /* Cambia el color al pasar el ratón (opcional) */
        }
        ...
        .portfolio-item-img:hover .lightbox {
            opacity: 1;
        }
    </style>
    ...
    <style>
        ...
        .video:hover {
            ...
            /* Levantar un poco al pasar el mouse */
...
<body>
    <!-- Animated Background -->
    <div class="lm-animated-bg" style="background-image: url({{ asset('assets/images/main_bg.png')}});"></div>
    <!-- /Animated Background -->
            ...
            <header id="site_header" class="header mobile-menu-hide">
                <div class="header-content">
                    <div class="header-photo">
                        <img src="{{ asset('assets/images/main_photo.jpeg') }}" alt="Fabian Enrique Suarez Carvajal">
                    </div>
                    <div class="header-titles">
                        <h2>Fabian Enrique Suarez Carvajal</h2>
                ...
                <div class="animated-sections">
                    ...
                    <section data-id="about-me" class="animated-section">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <p>Proin volutpat mauris ac pellentesque pharetra. Suspendisse congue elit vel odio
                                        suscipit, sit amet
                                        tempor nisl imperdiet. Quisque ex justo, faucibus ut mi in, condimentum finibus
                                        dolor. Aliquam vitae
                                        hendrerit dolor, eget imperdiet mauris. Maecenas et ante id ipsum condimentum
                                        dictum et vel massa.
                                    ...
                                    <div class="info-list">
                                        <ul>
                                            <li>
                                                ...
                                                <span class="value" id="age">Cargando...</span>
                                            </li>

                                            <li>
                                                <span class="title">Residence</span>
                                                <span class="value" id="residence">Cargando...</span>
                                            </li>

                                            <li>
                                                <span class="title">Address</span>
                                                <span class="value" id="address">Cargando...</span>
                                            </li>

                                            <li>
                                                <span class="title">e-mail</span>
                                                <span class="value" id="email">Cargando...</span>
                                            </li>

                                            <li>
                                                <span class="title">Phone</span>
                                                <span class="value" id="phone">Cargando...</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- <div class="info-list">
                      <ul>
                        ...
                        <li>
                          <span class="title">e-mail</span>
                          <span class="value"><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                              data-cfemail="76131b171f1a36130e171b061a135815191b">[email�&nbsp;protected]</a></span>
                        </li>
                                        ...
                                        <div class="testimonial">
                                            <div class="img">
                                                <img src="images/testimonial-1.jpg"
                                                    alt="Fabian Enrique Suarez Carvajal">
                                            </div>
                                            <div class="text">
                                                <p>Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor.
                                                    Nulla condimentum nunc
                                                    sit amet urna tempus finibus. Duis mollis leo id ligula
                                                    pellentesque, at vehicula dui
                                                    ultrices.</p>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="clients owl-carousel">
                                        ...
                                        <div class="client-block">
                                            <a href="#" target="_blank" title="Logo">
                                                <img src="images/client-7.png" alt="Logo">
                                            </a>
                                        </div>
                                        ...
                                        <div class="fw-package-wrap col-md-6 ">
                                            <div class="fw-package">
                                                ...
                                                <div class="fw-button-row">
                                                    <a href="#" target="_self" class="btn btn-secondary">Free
                                                        Trial</a>
                                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <div class="portfolio-content">
                                        ...
                                        <ul class="portfolio-filters">
                                            <li class="active">
                                                <a class="filter btn btn-sm btn-link" data-group="category_github">
                                                    <i class="fab fa-github"
                                                        style="font-size: 20px; margin-right: 5px;"></i> GitHub
                                                </a>
                                            </li>
                                            <li>
                                                <a class="filter btn btn-sm btn-link"
                                                    ...
                                                    <i class="fab fa-youtube"
                                                        style="font-size: 20px; margin-right: 5px;"></i> YouTube Videos
                                                </a>
                                            </li>
                                            <li>
                                                <a class="filter btn btn-sm btn-link" data-group="category_all">
                                                    <i class="fas fa-th"
                                                        style="font-size: 20px; margin-right: 5px;"></i> Todos
                                                </a>
                                            </li>
                                        </ul>


                                        <!-- Contenido de los Repositorios de GitHub -->
                                        <div class="portfolio-item category_github">
                                            <h2>Mis Repositorios de GitHub</h2>
                                            <br>
                                            <div id="repos"></div>
                                        </div>

                                        <!-- Contenido de los Videos de YouTube -->
                                        <div class="portfolio-item category_youtube-videos" style="display: none;">
                                            <h2>Mis Videos de YouTube</h2>
                                            <div class="video-container" id="videoContainer"></div>
                                            <a class="link"
                                                href="https://www.youtube.com/channel/UCH1jNr6hsEU5pbyvcC0QDqw"
                                                target="_blank">Visita mi canal de YouTube</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="blog-masonry two-columns clearfix">
                                            ...
                                            <div class="blog-card">
                                                <div class="media-block">
                                                    ...
                                                    <a href="blog-post-1.html">
                                                        <img src="images/blog_post_1.jpg"
                                        ...
                                        <div class="item post-2">
                                            <div class="blog-card">
                                                <div class="media-block">
                                                    ...
                                                    <a href="blog-post-1.html">
                                                        <img src="images/blog_post_2.jpg"
                                                            class="size-blog-masonry-image-two-c"
                                        ...
                                        <div class="item post-1">
                                            <div class="blog-card">
                                                <div class="media-block">
                                                    ...
                                                    <a href="blog-post-1.html">
                                                        <img src="images/blog_post_3.jpg"
                                                            class="size-blog-masonry-image-two-c"
                                        ...
                                        <div class="item post-2">
                                            <div class="blog-card">
                                                <div class="media-block">
                                                    <div class="category">
                                                        <a href="#" ti<link rel="stylesheet"
                                                            href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                                                            tle="View all posts in E-Commerce">UI</a>
                                                    </div>
                                                    <a href="blog-post-1.html">
                                                        <img src="images/blog_post_4.jpg"
                                                            class="size-blog-masonry-image-two-c"
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    ...
                                    <div class="lm-info-block gray-default">
                                        ...
                                        <h4><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                data-cfemail="5c3d3039241c39243d312c3039723f3331">[email�&nbsp;protected]</a>
                                        </h4>
                                        <span class="lm-info-block-value"></span>
                                        <span class="lm-info-block-text"></span>
                                    </div>
    ...
    <script defer=""
        ...
        data-cf-beacon="{"
        rayid":"8d879e119919a001","version":"2024.10.4","r":1,"token":"94b99c0576dc45bf9d669fb5e9256829","servertiming":{"name":{"cfextpri":true,"cfl4":true,"cfspeedbrain":true,"cfcachestatus":true}}}"=""
        crossorigin="anonymous"></script>


    <script>
        const youtubeApiKey = "XXX"; // Reemplaza con tu clave de API
        const youtubeChannelId = "XXX"; // ID de tu canal
        const youtubeApiUrl =
            `https://www.googleapis.com/youtube/v3/search?key=${youtubeApiKey}&channelId=${youtubeChannelId}&part=snippet,id&order=date&maxResults=5`;
    ...
    <script>
        const username = "inge-fabiansuarez"; // Cambia esto por tu nombre de usuario de GitHub
        ...
        async function fetchRepos() {
            try {
                ...
                repos.forEach(repo => {
                    const repoElement = document.createElement("figure");
                    repoElement.classList.add("item", "lbaudio");
                    repoElement.innerHTML = `
            <a href="${repo.html_url}" target="_blank" title="${repo.name}" style="border: 2px solid white; padding: 10px; border-radius: 8px; display: inline-block; width: 100%;">
                    <i style="font-size: 50px;" class="fab fa-github"></i>
                      <h4 class="name">${repo.name}</h4>
                      <p class="category">${repo.language || "Sin lenguaje especificado"}</p>
                      <p style="color:white;">${repo.description || "Sin descripción disponible"}</p>
        ...
        filters.forEach(filter => {
            filter.addEventListener('click', function() {
                ...
                portfolioItems.forEach(item => {
                    if (selectedCategory === 'category_all' || item.classList.contains(
                            selectedCategory)) {
    ...
    <script>
        async function fetchLinkedInProfile() {
            const accessToken = 'WPL_AP1.iNr4EDN7KTMZ24Bo.d9gkLw=='; // Reemplaza con tu token de acceso
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    // Asigna los valores a la sección "About Me"
                    document.getElementById('about-description').innerText =
                        `Hola, soy ${profile.localizedFirstName} ${profile.localizedLastName} y soy ${profile.headline}.`;
                    document.getElementById('age').innerText = '32'; // Asigna tu edad aquí
                    document.getElementById('residence').innerText = 'USA'; // Asigna tu residencia aquí
                    document.getElementById('address').innerText =
                        '88 Some Street, Some Town'; // Asigna tu dirección aquí
                    document.getElementById('email').innerHTML =
                        `<a href="mailto:${profile.emailAddress}">${profile.emailAddress}</a>`; // Email desde la API si está disponible
                    document.getElementById('phone').innerText = '+0123 123 456 789'; // Asigna tu teléfono aquí
